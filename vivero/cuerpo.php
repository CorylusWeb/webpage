<div class="container-fluid"> 	
        ...
        <div class="col-xs-8 col-sm-8 col-md-8">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 box">
                    ...
                    <p>Te brindamos experiencia, calidad y precio.</p>
                </div>
            </div>
             <div class="row" style="margin-top: 40px; margin-bottom: 40px;">
                <div class="col-xs-12 col-sm-12 col-md-4 servicio">
                    <img src="img/font-svg/ic_opacity_black_48px.svg" alt="Riego">
                    <h4>Riego</h4>
                    <p>Instalación, automatización, mantenimiento y reparación de riegos por aspersión. </p>
                    <a href="#" class="button-desciprion">Ver trabajos</a>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 servicio">
                    <img src="img/font-svg/ic_filter_hdr_black_48px.svg" alt="Nivelación">
                    <h4>Nivelación</h4>
                    <p>Relleno y nivelacón de terrenos. Proveemos tierra sarandeada a granel.</p>
                    <a href="#" class="button-desciprion">Ver trabajos</a>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 servicio">
                    <img src="img/font-svg/ic_spa_black_48px.svg" alt="Césped">
                    <h4>Césped</h4>
                    <p>Colocación de panes de grama bahiana de primera calidad.</p>
                    <a href="#" class="button-desciprion">Ver trabajos</a>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 banner">
                <div class="banner-body">
                    ...
                    <a href="#" class="button-banner">Contactanos</a>
                </div>
        ...
        <div class="col-xs-8 col-sm-8 col-md-8">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 box">
                    <h3>Productos</h3> 
                    <div class="title-decorator"></div>
                    <p>Gran variedad de productos para tu jardín</p>
                </div>
            </div>
            <div class="row" style="margin-top: 40px; margin-bottom: 40px;">
                <div class="col-xs-12 col-sm-12 col-md-6">
                    <!--<img src="img/cactus.png" style="float: left; width: 100%;">-->
                ...
                <div class="col-xs-12 col-sm-12 col-md-6">
                    <ul class="productos-items" style="float: left; ">
                        <li><img src="img/font-svg/ic_done_black_48px.svg">Plantas de interior</li>
                        <li><img src="img/font-svg/ic_done_black_48px.svg">Plantas de exterior</li>
                        <li><img src="img/font-svg/ic_done_black_48px.svg">Agroquimicos</li>
                        <li><img src="img/font-svg/ic_done_black_48px.svg">Macetas</li>
                        <li><img src="img/font-svg/ic_done_black_48px.svg">Semillas</li>
                        <li><img src="img/font-svg/ic_done_black_48px.svg">Tierra y abono</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="row trabajos-imgs">
                        <div class="col-xs-12 col-sm-4 col-md-4 trabajo-1 container">
                            <div class="overlay">
                                <div class="text">Titulo
                                <div class="title-decorator"></div>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce commodo lacus sit amet mauris scelerisque, ullamcorper ultrices magna sagittis.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-4 col-md-4 trabajo-2 container">
                            <div class="overlay">
                                <div class="text">Titulo
                                <div class="title-decorator"></div>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce commodo lacus sit amet mauris scelerisque, ullamcorper ultrices magna sagittis.</p>
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4 trabajo-3 container">
                            <div class="overlay">
                                <div class="text">Titulo
                                <div class="title-decorator"></div>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce commodo lacus sit amet mauris scelerisque, ullamcorper ultrices magna sagittis.</p>
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4 trabajo-4 container">
                            <div class="overlay">
                                <div class="text">Titulo
                                <div class="title-decorator"></div>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce commodo lacus sit amet mauris scelerisque, ullamcorper ultrices magna sagittis.</p>
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4 trabajo-5 container">
                            <div class="overlay">
                                <div class="text">Titulo
                                <div class="title-decorator"></div>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce commodo lacus sit amet mauris scelerisque, ullamcorper ultrices magna sagittis.</p>
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4 trabajo-6 container">
                            <div class="overlay">
                                <div class="text">Titulo
                                <div class="title-decorator"></div>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce commodo lacus sit amet mauris scelerisque, ullamcorper ultrices magna sagittis.</p>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="side-text">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce commodo lacus sit amet mauris scelerisque, ullamcorper ultrices magna sagittis. Suspendisse pretium vel eros tempus scelerisque.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 contacto">
            <div class="row">
                <div class="col-xs-1 col-sm-1 col-md-1"></div>
                <div class="col-xs-12 col-sm-12 col-md-5">
                    <div class="formulario">
                        <h3>Contacto</h3>
                        <p>Envianos tu consulta, sin compromiso.</p>
                        <input type="text" placeholder="Nombre">
                        <input type="text" placeholder="Email">
                        <input type="text" placeholder="Teléfono">
                        <textarea placeholder="Tu comentario"></textarea>
                        <a href="#" class="button-banner" style="margin-top: 10px;">Enviar</a>
                    </div>
                    
                </div>
                <div class="col-xs-12 col-sm-12 col-md-5">
                    <div class="ubicacion">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3285.775467448738!2d-58.713216284771455!3d-34.55923998047108!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95bcbda3a8f70cb3%3A0xa35bf4b787a98415!2sVivero+Ismael!5e0!3m2!1ses-419!2sar!4v1512498861592" width="400" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
                    </div>
                    <div class="datos">
                        <ul class="datos-items" style="float: left; ">
                            <li><img src="img/font-svg/ic_location_on_black_48px.svg"> Av. Gaspar Campos 2265 - San Miguel, Pcia. de Buenos Aires</li>
                            <li><img src="img/font-svg/ic_phone_black_48px.svg"> +54 (011) 4451-4255 | 15 5226-8020</li>
                            <li>Lunes a sábados, 8:00hs a 13:00hs - 16:00hs a 20:00hs. Domingos 9:30hs a 13:30hs</li>
                        </ul>
                        <div class="social">
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-6">
                                    <a href=""><img src="img/font-svg/instagram.svg">@vivero.ismael_</a>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-6">
                                    <a href=""><img src="img/font-svg/facebook.svg">/Vivero Ismael</a>
                                </div>
                            </div>                            
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="developed">
                        <p>Hecho con <span><img src="img/font-svg/heart.svg" ></span> por Jere y Coti</p>
                    </div>
                </div>
            </div>
        </div>
